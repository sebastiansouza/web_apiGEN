...
@router.put("/users/{user_id}", status_code=status.HTTP_200_OK, response_model=User)
...
@router.delete("/users/{user_id}", status_code=status.HTTP_200_OK, response_model=User)
